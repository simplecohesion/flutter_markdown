...
void defineTests() {
  group('Data', () {
    testWidgets('simple data', (WidgetTester tester) async {
  ...
  group('Text', () {
    testWidgets('Empty string', (WidgetTester tester) async {
      ...
      expectWidgetTypes(widgets, <Type>[MarkdownBody, Column]);
    });
  ...
  group('Line Break', () {
    ...
    testWidgets('soft line break', (WidgetTester tester) async {
      const data = 'line 1.\nline 2.';
      await tester.pumpWidget(
        boilerplate(const MarkdownBody(data: data, softLineBreak: true)),
      );
  ...
  group('Selectable', () {
    testWidgets('header with line of text', (WidgetTester tester) async {
      const data = '# Title\nHello _World_!';
      await tester.pumpWidget(
        boilerplate(
          const MediaQuery(
            data: MediaQueryData(),
            child: Markdown(data: data, selectable: true),
          ),
        ),
      );
    ...
    testWidgets('header with line of text and onTap callback', (
      WidgetTester tester,
    ) async {
      const data = '# Title\nHello _World_!';
      ...
      final selectableWidgets = tester.widgetList(
    ...
    testWidgets('Selectable without onSelectionChanged', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Material(child: MarkdownBody(data: data, selectable: true)),
        ),
      );
    ...
    testWidgets('header with line of text and onSelectionChanged callback', (
      WidgetTester tester,
    ) async {
      const data = '# abc def ghi\njkl opq';

  ...
  group('Style Sheet', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final MarkdownStyleSheet style1 = MarkdownStyleSheet.fromCupertinoTheme(
          theme,
        );
        final MarkdownStyleSheet style2 = MarkdownStyleSheet.fromCupertinoTheme(
          theme,
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final MarkdownStyleSheet style = MarkdownStyleSheet.fromCupertinoTheme(
          cTheme,
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final MarkdownStyleSheet style1 = MarkdownStyleSheet.fromTheme(theme);
        final MarkdownStyleSheet style2 = MarkdownStyleSheet.largeFromTheme(
          theme,
        );

  ...
  group('Table', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Iterable<DefaultTextStyle> styles = tester.widgetList(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final MarkdownStyleSheet style = MarkdownStyleSheet.fromTheme(
          theme,
    ...
    group('GFM Examples', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(cellText[1], 'b | az');
          expect(cellText[2], 'b | im');
          expect(table.defaultColumnWidth, columnWidth);
        },
      );

...
class MarkdownStyleSheet {
  ...
  /// Creates a [MarkdownStyleSheet] from the [TextStyle]s in the provided
  /// [ThemeData].
  factory MarkdownStyleSheet.fromTheme(ThemeData theme) {
    assert(
      theme.textTheme.bodyMedium?.fontSize != null,
      'Theme: Body medium font size is null',
    );
  ...
  factory MarkdownStyleSheet.fromCupertinoTheme(CupertinoThemeData theme) {
    assert(
      ...
      'Theme: Text style font size is null',
    );
    return MarkdownStyleSheet(
  ...
  /// Creates a [MarkdownStyleSheet] from the [TextStyle]s in the
  /// provided [ThemeData].
  ///
  ...
  MarkdownStyleSheet copyWith({
    ...
    assert(
      ...
      'textScaleFactor is deprecated and cannot be specified when textScaler'
      ' is specified.',
    );
